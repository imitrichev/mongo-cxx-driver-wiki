...
##### Client Options
 ...
 - `--sharedclient` Builds a shared library version of the client driver alongside the static library. If applicable for your application, prefer using the shared client.
   - NOTE:  The default authorization mechanism since MongoDB version 3.0 is [SCRAM-SHA-1](http://docs.mongodb.org/manual/reference/program/mongo/). If you want to use standard MongoDB authentication, you should compile with --ssl option for SCRAM-SHA-1 mechanism support.
